...
struct Surface
{
    ...
    Vec3f vertex1; // libsm64: 32 bit
    Vec3f vertex2; // libsm64: 32 bit
    Vec3f vertex3; // libsm64: 32 bit
    struct {
        f32 x;
        f32 y;
        f32 z;
...
struct MarioState
{
    ...
    /*0x74*/ s16 floorAngle;
    /*0x76*/ f32 waterLevel; // libsm64: 32 bit (address offsets after this are wrong)
